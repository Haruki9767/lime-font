...
import { ChevronDown, Copy, Github, Menu, Minus, Plus, X } from "lucide-react";
  ...
  return (
    <div className="site-shell">
      <header className="site-header" id="top">
        ...
        <a className="text-link header-repo-link" href="https://github.com/Haruki9767/lime-font" target="_blank" rel="noreferrer">View on GitHub <Github size={15} aria-hidden="true" /></a>
      ...
      <main>
        ...
        <section className="about-section" id="about" aria-labelledby="about-title">
          ...
          <div className="about-copy">
            ...
            <a className="button-link" href="https://github.com/Haruki9767/lime-font" target="_blank" rel="noreferrer"><Github size={16} /> View on GitHub</a>
          </div>
        </section>
      </main>
